...
<div id="content" class="app-content">
    ...
    <div class="mb-3 d-md-flex fw-bold">
        <div class="mt-md-0 mt-2">
            <a href="#" class="text-decoration-none text-dark"><i class="fa fa-print fa-fw me-1 text-dark text-opacity-50"></i>
                Print</a>
        </div>
        <div class="ms-md-4 mt-md-0 mt-2">
            <a href="#" class="text-decoration-none text-dark"><i class="fa fa-boxes-stacked fa-fw me-1 text-dark text-opacity-50"></i>
                Restock items</a>
        </div>
        <div class="ms-md-4 mt-md-0 mt-2">
            <a href="#" class="text-decoration-none text-dark"><i class="fa fa-pen fa-fw me-1 text-dark text-opacity-50"></i>
                Edit</a>
        </div>
        <div class="ms-md-4 mt-md-0 mt-2 dropdown-toggle">
            <a href="#" data-bs-toggle="dropdown" class="text-decoration-none text-dark text-opacity-75"><i class="fa fa-cog fa-fw me-1 text-dark text-opacity-50"></i>
                More Actions <b class="caret"></b></a>
    ...
    <div class="row gx-4">
        <div class="col-lg-8">
                ...
                <div class="card-body p-3 text-dark fw-bold">
                    <div class="row align-items-center">
                        <div class="col-lg-8 d-flex align-items-center">
                            ...
                            <div class="ps-3 flex-1">
                                <div>
                                    <a href="#" class="text-decoration-none text-dark">iPhone 13 Pro Max</a>
                                </div>
                        ...
                        <div class="col-lg-2 m-0 ps-lg-3">$999 x 1</div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 d-flex align-items-center">
                            ...
                            <div class="ps-3 flex-1">
                                <div class>
                                    <a href="#" class="text-decoration-none text-dark">Macbook Pro 2020</a>
                                </div>
                                <div class="text-dark text-opacity-50 small fw-bold">
                                    SKU: MACBOOKPRO-1TB
                                </div>
                        ...
                        <div class="col-lg-2 m-0 ps-lg-3">$1,999 x 1</div>
                        <div class="col-lg-2 text-dark fw-bold m-0 text-end">
                            $1,999
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 d-flex align-items-center">
                            ...
                            <div class="ps-3 flex-1">
                                <div class>
                                    <a href="#" class="text-decoration-none text-dark">Apple Watch 5</a>
                                </div>
                                <div class="text-dark text-opacity-50 small fw-bold">
                                    SKU: APPLEWATCHBLACK
                                </div>
                        ...
                        <div class="col-lg-2 m-0 ps-lg-3">$599 x 1</div>
                        <div class="col-lg-2 text-dark fw-bold m-0 text-end">
                            $599
                        </div>
                    </div>
            ...
            <div class="card border-0">
                <div class="card-header bg-none p-3 h6 m-0 d-flex align-items-center">
                    ...
                    Payment Records
                    <a href="#" class="ms-auto text-decoration-none text-gray-500"><i class="fab fa-paypal me-1 fa-lg"></i> View paypal
                        records</a>
                </div>
                <div class="card-body">
                    <table class="table table-borderless table-sm fw-bold m-0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    promo code:
                                    <u class="text-success">FREESHIPPING</u>
                            ...
                            <tr>
                                <td class="pt-2 pb-2" nowrap>Paid by customer</td>
                                <td class="pt-2 pb-2">
                                    via
                                    <a href="#" class="text-primary text-decoration-none">Paypal</a>
                                    (#IRU9589320)
                                </td>
        ...
        <div class="col-lg-4">
            <div class="card border-0 mb-4">
                ...
                <div class="card-body">No notes from customer</div>
            </div>
            <div class="card border-0 mb-4">
                <div class="card-header bg-none p-3 h6 m-0 d-flex align-items-center">
                    Customer
                ...
                <div class="card-body fw-bold">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-1 ps-3">
                            ...
                            <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="abc1c4c3c5d8c6c2dfc3ebccc6cac2c785c8c4c6">[email&#160;protected]</a>
                        </div>
                    </div>
                </div>
            </div>
